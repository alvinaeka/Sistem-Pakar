...
@section('title', 'Manage Data Latih Penyakit')
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Latih Penyakit</h3>
                    ...
                    <div class="card-body table-responsive-md">
                        <table id="datatable"class="table table-hover" data-page-length='25'>
                            ...
                            <tr>                              
                                ...
                                <td> {{$valuedatalatih["nama_penyakit"]}} </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary edit-category" data-toggle="modal" data-target="#editdatamodal" data-pengujian="{{ $valuedatalatih['pengujian_ke'] }}" data-penyakit="{{ $valuedatalatih['id_penyakit']}}" data-gejala="{{ json_encode($valuedatalatih['id_gejala'])}}">Edit</button>
                                    <form action="/ManageDataLatihPenyakit/{{ $valuedatalatih['pengujian_ke'] }}/" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf 
...
<div class="modal fade" id="tambahdatamodal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form method="post" role="form" id="tambahdataform" action="/ManageDataLatihPenyakit">
                        @csrf
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                @csrf
                    <div class="form-group">
                        <label for="penyakit">Nama Penyakit</label>
                        <select class="form-control" name="penyakit_id" id="selectpenyakit">
                        <option disabled> -- pilih gejala -- </option>
                        @foreach($penyakits as $pen)
                    ...
                    <div class="form-group" id="edit_gejala">
                        ...
                        @foreach($gejalas as $gejalaspenyakit)
                        <option value="{{ $gejalaspenyakit->id }}">{{ $gejalaspenyakit->nama }}</option>
                        @endforeach
                        </select>
                    </div>
                </div>
...
<script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            $('.edit-category').on('click', function() {
                ...
                var url = "{{ url('ManageDataLatihPenyakit') }}/" + pengujian;
                $('#editdatamodal form').attr('action', url);
                $('#selectpenyakit').val(penyakit);
                $('#edit_gejala').empty();
            ...
            messages: {
                "penyakit_id": {
                    required: "Silahkan pilih penyakit untuk diubah",
                },
                "gejala_id[]": {
