                    ...
                    <div class="col-md-7">
                        <div class="card">
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                    <td width="30%">Nama penyakit</td>
                                    <td>{{$penyakits["nama"]}}</td>
                                    </tr>
                                    <tr>
                                    <td width="30%">Nama lain</td>
                                    <td>{{$penyakits["nama_lain"]}}</td>
                                    </tr>
                                    <tr>
                                    <td width="30%">Gejala</td>
                                    <td>
                                            @foreach($penyakits->penyakit_gejala as $gejala)
                                            <li> {{ $gejala->nama }} </li>
                                            @endforeach
                                    </td>
                                    </tr>
                        ...
                        <a href="/DiagnosaPenyakit" class="btn btn-secondary">Kembali</a>
                        <a href="/RiwayatDiagnosaPenyakit" class="btn btn-primary">Lihat riwayat</a>
                        </div>                
                    </div>
                </div>
            </div>
